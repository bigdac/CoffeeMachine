package vendingmachine.xr.com.coffeemachine.constants;
...
public interface IConstant {
    Option SERIAL_PORT = new Option("串口号",new String[]{"ttyO3","ttyS0","ttyS1","ttyS2","ttyS3","ttyS4","ttyS5","ttyS6","ttyS7","ttyS8","ttyS9","ttyXRM0","ttyXRM1","ttymxc1"});
